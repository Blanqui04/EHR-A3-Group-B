...
We analyzed a total of 53.417 ICU admissions, from which \textbf{7261 admissions (13.59\%)} were associated with a sepsis diagnosis based on ICD-9-CM codes. The sepsis definition encompassed patients with any of the following codes: septicemia (038.x), sepsis (995.91), severe sepsis (995.92), or septic shock (785.52).
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\columnwidth]{figures/sepsis_distribution_icu.pdf}
