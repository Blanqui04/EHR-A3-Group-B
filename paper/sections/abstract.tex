...
We conducted a retrospective cohort study using the MIMIC-III database, analyzing 53,417 adult ICU admissions from Beth Israel Deaconess Medical Center (2001--2012). Sepsis cases were identified using ICD-9-CM codes (038.x, 995.91, 995.92, 785.52). We estimated sepsis prevalence, compared in-hospital mortality between sepsis and non-sepsis patients, and developed a logistic regression model to predict mortality among sepsis patients.
