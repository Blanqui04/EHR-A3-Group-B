This retrospective study examined the epidemiology and in-hospital mortality of sepsis among ICU admissions using the MIMIC-III database. The key findings demonstrate a substantial clinical burden of sepsis and identify relevant associations with mortality outcomes.
...
The absence of multicollinearity (all VIF values < 2.0) indicates that the selected predictors are statistically independent and appropriate for inclusion in the model. However, the modest AUC of 0.622 highlights a fundamental limitation: demographic and administrative variables do not capture the physiologic complexity of sepsis severity. Clinical variables such as vital signs, lactate levels, organ dysfunction scores (SOFA, APACHE), and infection source are likely necessary to achieve clinically meaningful discrimination \cite{sepsis3}.
